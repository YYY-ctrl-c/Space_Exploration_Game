...
INSERT INTO `users` VALUES (1, 'admin', '星际总指挥', 'admin', '/avatars/txone.jpg', 100000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO `user_items` VALUES (1, 1, 16, 10); -- 给管理员发10个聚变电池测试用
...
INSERT INTO `user_crew` VALUES (1, 1, 1, '先锋01号', CURRENT_TIMESTAMP, 0, 50, 1);
